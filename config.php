...
if (_TIPO_CONEXION == "localhost"){
  ...
  define('_PASSWORD','');
  define('_BASE_DE_DATOS','kintos_1');
  
  define('_RUTA_SERVER',str_replace("","",$_SERVER['DOCUMENT_ROOT'])."/server/");
  define('_RUTA_NUCLEO',_RUTA_SERVER."nucleo/");
  define('_RUTA_HOST',_RUTA_SERVER."kintos/");

  define('_RUTA_WEB',"http://localhost/server/kintos/");
...
if (_TIPO_CONEXION == "online"){
  ...
  define('_BASE_DE_DATOS','hermanyu_kintos_1');
  ...
  define('_RUTA_WEB',"http://kintos.in/");
...
define('_PIE_PAGINA', "2018 <strong>®</strong> Derechos Reservados Kintos ");
